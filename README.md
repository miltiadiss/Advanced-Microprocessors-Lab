...
For the execution of the exercises we use **ATmega4808-4809** microprocessor. The main goal is to program the microprocessor in order to simulate the function of some "smart" appliances and devices with its LEDs.  
...
For this course we will be using *TCA0* in both single and split mode (or *TCB0*, *TCB1*)
